...
class ViewController: UIViewController, CLLocationManagerDelegate {
    ...
    override func viewDidLoad() {
        ...
        // Shows clock timer
        var timer = Timer.scheduledTimer(timeInterval: 1.0, target: self, selector: #selector(ViewController.clockTimerAction), userInfo: nil, repeats: true)
    }
    ...
    func locationButtonAction(_ sender: UIButton!) {
        ...
        // Start the timer
        minuteTimer = Timer.scheduledTimer(timeInterval: 5, target: self, selector: #selector(pressedTimerAction), userInfo: nil, repeats: false)
